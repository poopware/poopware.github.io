		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>uzi abi cekir</strong></h4>

					<textarea rows="12" class="form-control text-center form-checker mb-2" placeholder="kartları alim"></textarea>
...
<footer>
  <p>Cracked,Rescripted By <a href="https://discord.com/users/1014228805856002068">@voltou'</a></p>
</footer>
<script>
...
swalWithBootstrapButtons.fire({
  title: "uzi abi yarragini yiyeyim", 
  text: "olr mu ?? uxwu",
  icon: 'warning',
  showCancelButton: true,
  confirmButtonText: 'yala oçç',
  cancelButtonText: 'amimi yiycenmi',
...
if(total > 10000){
  Swal.fire({title: 'abiğ kart koyma limiti 10000 amk sen naptın <9999', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
...
var callBack = $.ajax({
	...
	success: function(retorno){
		...
		if(testadas == total){
			Swal.fire({title: 'abiğ hepsini checkledim', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
